...
btn_sub = tk.Button(root, text="_", command = lambda: add_to_calc("-"), width=5, font=("Arial",14))
...
btn_equals = tk.Button(root, text="=", command = eval_calc, width=11, font=("Arial",14))
btn_equals.grid(row=6, column=3, columnspan=2)

btn_clear = tk.Button(root, text="Clear", command = cl_calc, width=11, font=("Arial",14))
